...
var AddonModLessonPlayerPage = /** @class */ (function () {
    ...
    AddonModLessonPlayerPage.prototype.launch = function () {
        var currentSite = this.sitesProvider.getCurrentSite();
        this.utils.openInApp(currentSite.getURL() + '/mod/lesson/view.php?startlastseen=no&lang=fa&id=' + this.lesson.coursemodule + '&pageid=' + this.currentPage);
    };
    __decorate([
